 ...
 */
public class TourPriceDurationComparatorTest {
    @Test
    public void sortTourListUsingComparatorByPriceDuration() throws Exception {
        ...
        Collections.sort(actualTours, new TourPriceDurationComparator());

        ArrayList<Tour> expectedTours = new ArrayList<Tour>();

        parsingMultiData = dataParser.parse(textFileReader.read("src/main/resources/test/comparator/sortedByPriceDurationTourList.txt"));
